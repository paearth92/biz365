...
export const products: Product[] = [
  {
    ...
    image: "/images/products/cutouts/nfcplate-google-review-stand-transparent.png", imageAlt: "NFCPlate freestanding Google Review Stand with NFC tap and QR scan options",
    shortDescription: "A premium counter stand that puts your Google review page one tap or scan away.",
    description: "Make the review request effortless at the exact moment a customer is happiest. The flagship NFCPlate stand combines fast NFC with a clear QR-code alternative in a professional counter-ready format.",
    ...
    variants: [
      { id: "grs-blue", name: "Standard design", sku: "B365-GRS", price: 29, inStock: true },
    ], relatedProductSlugs: ["google-review-card", "review-starter-bundle", "google-review-sticker"],
    seoTitle: "Google Review Stand with NFC + QR | NFCPlate", seoDescription: "Help customers reach your genuine Google review page with one NFC tap or QR scan using the premium NFCPlate counter stand."
  },
  {
    ...
    image: "/images/products/cutouts/biz365-compact-google-review-stand-nfc-qr-transparent.webp", imageAlt: "Compact NFCPlate Google Review countertop stand with NFC tap and QR scan",
    ...
    variants: [{ id: "cgrs-black", name: "Standard design", sku: "B365-CGRS", price: 24, inStock: true }],
    relatedProductSlugs: ["google-review-stand", "google-review-card"], seoTitle: "Compact NFC Google Review Stand | NFCPlate", seoDescription: "Save counter space while giving customers fast NFC tap and QR scan access to your review page."
  },
  {
    ...
    image: "/images/products/cutouts/biz365-google-review-card-nfc-qr-transparent.webp", imageAlt: "Landscape NFCPlate Google Review wallet card showing NFC tap and QR scan",
    ...
    relatedProductSlugs: ["google-review-stand", "review-starter-bundle", "business-review-bundle"], seoTitle: "NFC Google Review Card with QR | NFCPlate", seoDescription: "Carry your Google review link with a durable NFCPlate NFC and QR review card."
  },
  {
    ...
    image: "/images/products/cutouts/biz365-google-review-sticker-nfc-qr-transparent.webp", imageAlt: "Thin adhesive NFCPlate Google Review stickers with NFC tap and QR scan",
    ...
    relatedProductSlugs: ["google-review-plate", "google-review-stand", "business-review-bundle"], seoTitle: "NFC Google Review Sticker with QR | NFCPlate", seoDescription: "Add tap-or-scan review access to a counter, door or display with an NFCPlate smart sticker."
  },
  {
    ...
    image: "/images/products/cutouts/biz365-google-review-plate-nfc-qr-transparent.webp", imageAlt: "Rigid adhesive-backed NFCPlate Google Review plate with NFC tap and QR scan",
    ...
    variants: [{ id: "grp-black", name: "Standard design", sku: "B365-GRP", price: 19, inStock: true }],
    relatedProductSlugs: ["google-review-sticker", "google-review-stand"], seoTitle: "Google Review NFC Plate + QR | NFCPlate", seoDescription: "Create a permanent tap-or-scan review touchpoint with a professional NFCPlate display plate."
  },
  {
    ...
    image: "/images/products/cutouts/biz365-review-starter-bundle-nfc-qr-transparent.webp", imageAlt: "NFCPlate Google Review Starter Bundle with one counter stand and one wallet card",
    ...
    variants: [{ id: "rsb-blue", name: "Standard bundle", sku: "B365-RSB", price: 39, compareAtPrice: 43, inStock: true }],
    relatedProductSlugs: ["google-review-stand", "google-review-card", "business-review-bundle"], seoTitle: "Google Review Starter Bundle | NFCPlate", seoDescription: "Cover your counter and customer handoffs with an NFCPlate NFC and QR review stand and card bundle."
  },
  {
    ...
    image: "/images/products/cutouts/biz365-business-review-bundle-nfc-qr-transparent.webp", imageAlt: "NFCPlate Business Review Bundle with two stands, two cards and three stickers",
    ...
    variants: [{ id: "brb-black", name: "Standard bundle", sku: "B365-BRB", price: 69, compareAtPrice: 95, inStock: true }],
    relatedProductSlugs: ["review-starter-bundle", "google-review-stand", "google-review-sticker"], seoTitle: "Business Google Review Bundle | NFCPlate", seoDescription: "Equip multiple customer touchpoints with NFCPlate NFC and QR review stands, cards and stickers."
  },
  {
    ...
    image: "/images/products/cutouts/biz365-instagram-follow-stand-nfc-qr-transparent.webp", imageAlt: "NFCPlate Instagram Follow Stand with Instagram gradient, NFC tap and QR scan",
    ...
    variants: [{ id: "ifs-blue", name: "Standard design", sku: "B365-IFS", price: 29, inStock: true }],
    relatedProductSlugs: ["google-review-stand", "business-review-bundle"], seoTitle: "Instagram NFC Follow Stand + QR | NFCPlate", seoDescription: "Help customers reach and follow your Instagram profile with an NFCPlate NFC and QR stand."
  },
];
