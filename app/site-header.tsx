  ...
  return (
    <header className="site-header">
      <div className="shell header-inner">
        <Link className="logo" href="/" aria-label="NFCPlate home">
          <BrandLogo header priority />
        </Link>
        <nav className="desktop-nav" aria-label="Main navigation">
          <div className="nav-group">
            ...
            <div className="dropdown premium-menu">
              <p>Shop tap-or-scan products</p>
              {products.map(([label, href, copy]) => (
              ...
              <Link className="menu-all" href="/shop">
                <span>
        ...
        <div className="header-actions">
          ...
          <button aria-label={`Open cart with ${count} items`} className="cart-icon" onClick={() => setCartOpen(true)}>
            <ShoppingBag />
            <span>{count}</span>
          </button>
      ...
      {open && (
        <nav className="mobile-nav" aria-label="Mobile navigation">
          <Link className="mobile-shop" href="/shop" onClick={() => setOpen(false)}>
