...
export const metadata:Metadata={title:"Your Cart | Biz365",description:"Review the standard Biz365 NFC and QR products in your shopping cart.",robots:{index:false,follow:false}};
