...
export const metadata: Metadata = {
  ...
  description: "Shop premium NFCPlate NFC and QR review stands, cards, stickers, plates and bundles for customer-facing businesses.",
};
      ...
      <section className="shop-hero">
        <div className="shell">
          <div className="shop-hero__copy">
            ...
            <p>Professional products that put your business destination one NFC tap or QR scan away.</p>
          </div>
